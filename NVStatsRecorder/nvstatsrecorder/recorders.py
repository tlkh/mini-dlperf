...
class NVStatsRecorder(StatsRecorder):
    ...
    def __init__(self, gpu_index=0, tensor_util=False, sudo_password=""):
        ...
        try:
            pcie_gen = nvmlDeviceGetCurrPcieLinkGeneration(self.handle)
            pcie_gen_lane_bw = self._get_pcie_gen_lane_bw(pcie_gen)
            pcie_width = nvmlDeviceGetCurrPcieLinkWidth(self.handle)
        ...
        while True:
            if self.stopped:
                ...
                if (
                    ...
                    print("[NVStats] Detected GPU throttle:", throttle_reason_str)
...
class NVLinkStatsRecorder(StatsRecorder):
    ...
    def _start_nvlink_counter(self):
        if self.sudo_password:
            ...
            return self._run_command("nvidia-smi nvlink -sc 0bz")
    ...
    def _reset_nvlink_counter(self):
        if self.sudo_password:
            ...
            return self._run_command("nvidia-smi nvlink -r 0")
    ...
    def _read_nvlink_counter(self):
        if self.sudo_password:
            ...
            return self._run_command("nvidia-smi nvlink -g 0")
